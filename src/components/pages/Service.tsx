    ...
    <>
      <div className="flex justify-center items-center flex-wrap py-18 gap-12">
        <div className="flex justify-center items-center flex-col p-2">
          ...
          <h3 className="text-[20px] font-bold">{t("FREE AND FAST DELIVERY")}</h3>
        ...
        <div className="flex justify-center items-center flex-col p-2">
          ...
          <h3 className="text-[20px] font-bold">{t("24/7 CUSTOMER SERVICE")}</h3>
        ...
        <div className="flex justify-center items-center flex-col p-2">
          ...
          <h3 className="text-[20px] font-bold">{t("MONEY BACK GUARANTEE")}</h3>
